pub use objc2_metal::MTLPixelFormat as PixelFormatReexport;
...
pub struct SwapchainConfig {
    pub pixel_format: objc2_metal::MTLPixelFormat,
...
impl Default for SwapchainConfig { fn default() -> Self { Self { pixel_format: objc2_metal::MTLPixelFormat::BGRA8Unorm, framebuffer_only: true, max_drawables: 3, present_mode: PresentMode::Fifo, colorspace: ColorSpace::SRGB, wants_edr: false } } }
