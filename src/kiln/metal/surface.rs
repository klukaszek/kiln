// Pixel format type is re-exported from the root of this module.
...
pub struct SwapchainConfig {
    pub pixel_format: crate::kiln::metal::MTLPixelFormat,
...
impl Default for SwapchainConfig {
    fn default() -> Self {
        Self {
            pixel_format: crate::kiln::metal::MTLPixelFormat::BGRA8Unorm,
...
pub trait MTLDrawableSource {
    ...
    fn color_pixel_format(&self) -> crate::kiln::metal::MTLPixelFormat;
}
