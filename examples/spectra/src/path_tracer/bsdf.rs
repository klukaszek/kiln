...
pub(super) fn lower(material: &Material) -> render::Result<PrincipledGgxParams> {
    ...
    let diffuse_luminance = surface.base_color.dot(Vec3::new(0.2126, 0.7152, 0.0722));
    let f0_luminance =
