...
use crate::base::scene::{CpuStorage, Scene, SceneStorage, Surface};
...
impl SceneStorage for Storage {
    ...
    fn build(
        ...
        let source_triangles = scene.geometry.world_triangles();
        let mut triangles = Vec::with_capacity(source_triangles.len());
