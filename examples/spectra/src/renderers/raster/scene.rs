...
gpu_struct! {
    pub(super) struct GpuRasterMaterial {
        color: Vec4,
        texture_id: u32,
        _pad: [f32; 3],
    }
...
pub(super) struct Storage {
    ...
    pub(super) materials: GpuArray<GpuRasterMaterial>,
    ...
    fn build(
        ...
        let materials = scene
            ...
            .map(|material| {
                ...
                GpuRasterMaterial {
                    color: raster_color(material).extend(1.0),
                    texture_id,
                    _pad: [0.0; 3],
                }
            })
...
fn raster_color(material: &Material) -> Vec3 {
...
mod tests {
    ...
    fn raster_vertex_stays_compact() {
        ...
        assert_eq!(size_of::<GpuRasterMaterial>(), 32);
    }
}
